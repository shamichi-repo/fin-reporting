...
def main(host: str, port: int):
    skill = AgentSkill(
        ...
        description="An AI agent that analyzes SAP S/4HANA SD customer orders and provides margin-safe discount recommendations",
        tags=["discount", "strategy", "agent"],
        examples=["What discounts can I offer customer C1000?", "Analyze order 1000000 for discount options"],
    )
